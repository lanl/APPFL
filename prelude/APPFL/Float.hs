...
module APPFL.Float( module APPFL.Float, Float(..), Double(..), Float#, Double#
...
import APPFL.Real
import APPFL.Arr
import APPFL.Float.RealFracMethods
import APPFL.Float.ConversionUtils
import APPFL.Integer.Logarithms ( integerLogBase# )
import APPFL.Integer.Logarithms.Internals
