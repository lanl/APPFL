...
greatly simplifies the task of definining more complex behavior.  Without it,
each matched parameter of a function requires an additional level of nested
\texttt{case} expresssions. The same is true of each level of nesting within a
single pattern.
...
\item Type Annotations \\
  ...
  mini-Haskell's type annotations (or signatures) behave similarly to those in
  Haskell, being passed to the typechecker as initial assumptions.

% I don't think I've described this very well at all... - david
\item Haskell Block \\
  Being a subset of Haskell, it may be desireable to test a mini-Haskell program
