...
\begin{itemize}
  ...
  \item<8-9> Parallel runtimes, e.g., Cilk Plus, Intel Threading Building Blocks,
    ...
    \\\only<8>{\ \ Automated scheduling for irregularly shaped problems. Task-based}
\end{itemize}
\only<9>{%
\textbf{
...
Inherent problems:
\begin{itemize}
\item Idle processors during relatively slow writes burn tight energy budgets.
